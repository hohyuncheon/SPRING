...
update
    member
set
    password = '$2a$10$J8ynZs9UwhgK7bBYAxFgYudbtTyCJBbQrm1tJeIiCeDMxcUe.SN1G'
where 
    id = 'admin';
...
select 
    *
from board B join attachment A 
    on B.no = A.board_no
order by
    B.no desc;
...
insert into attachment
values (seq_attachment_no.nextval, 60, 'moon.jpg', '20200525_090909_123.jpg', default, default, default);

insert into attachment
values (seq_attachment_no.nextval, 59, 'sun.jpg', '20200525_020425_123.jpg', default, default, default);
